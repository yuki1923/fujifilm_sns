  ...
  <div class="container">
    <div class="contant site-width">
      ...
      <div class="iner-width">
        <i class="fas fa-heart js-click-heart <?php if(isFav($_SESSION['user_id'],$viewData['post_id'])){ echo ' active'; } ?>" data-photoid="<?php echo sanitize($viewData['post_id']); ?>" ><span class="heart-text">いいね</span></i>
