      ...
      <section class="main">
        <form method="post" class="regist-form" enctype="multipart/form-data">
          ...
          <select name="situ" class="regist-photo-list">
            <option value="0" <?php if(getFormData('situ') == 0){echo 'selected';} ?> >選択してください</option>
            <?php foreach ($dbSituation as $key => $val) : ?>
              <option value="<?php echo $val['id']; ?>" <?php if(getFormData('situ') === $val['id']){echo 'selected';} ?> > <?php echo $val['name']; ?> </option>
            <?php endforeach; ?>
          </select>
          ...
          <select name="lens" class="regist-photo-list">
            ...
            <?php foreach ($dbLens as $key => $val) : ?>
              <option value="<?php echo $val['id']; ?>"<?php if(getFormData('lens')=== $val['id']){echo 'selected';} ?> ><?php echo $val['name']; ?></option>
            <?php endforeach; ?>
          </select>
          ...
          <select name="film" class="regist-photo-list">
            ...
            <?php foreach ($dbFilm as $key => $val) : ?>
              <option value="<?php echo $val['id']; ?>" <?php if(getFormData('film')=== $val['id']){echo 'selected';} ?> ><?php echo $val['name']; ?></option>
            <?php endforeach; ?>
          </select>
